...
onmt_train -data Data/SVO_AN -save_model Results/SVO_AN_model

# onmt_train -data Data/SVO_AN -early_stopping 3 -valid_steps 1000 -save_model Results/SVO_AN_model

# onmt_train -data Data/SVO_NA --early_stopping 3 -valid_steps 1000 -save_model Results/SVO_NA_model

# onmt_train -data Data/SOV_AN --early_stopping 3 -valid_steps 1000 -save_model Results/SOV_AN_model

# onmt_train -data Data/SOV_NA --early_stopping 3 -valid_steps 1000 -save_model Results/SOV_NA_model